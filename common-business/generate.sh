...
TARGET_ENTITY="com.wsmhz.${GROUP}.${SERVER}.domain.entity"
TARGET_MAPPER="com.wsmhz.${GROUP}.${SERVER}.mapper"
...
<generatorConfiguration>
    <context id="info" targetRuntime="MyBatis3">
        ...
        <!--启用Lombok插件-->
        <plugin type="com.wsmhz.common.plugin.LombokPlugin"/>
        <commentGenerator type="com.wsmhz.common.plugin.CommentGenerator">
            <!--去除自动生成的注释-->
